...
export const TRANSLATIONS = {
  ...
  [Language.GU]: {
    ...
    back: "પાછળ", save: "રિપોર્ટ સાચવો", analyzing: "વિશ્લેષણ થઈ રહ્યું છે...", loading: "લોડ થઈ રહ્યું છે...",
    confidence: "વિશ્વસનીયતા", severity: "તીવ્રતા", low: "ઓછી", moderate: "મધ્યમ", high: "વધુ",
